...
public partial class ReportingDbContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        ...
        {
            // Use the connection string from configuration (e.g., appsettings.json or environment variable)
            optionsBuilder.UseSqlServer("Name=ConnectionStrings:ReportingDb");
        }
    }
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.SystemInformationId).HasName("PK__BuildVer__35E58ECAC9112972");
